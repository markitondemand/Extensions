...
public class NotificationHandle {
    ...
    ///   - center: The notification center to watch from (Default is `NotificationCenter.default`)
    ///   - filterObject: The object to filter on (Default is `nil`)
    ///   - queue: The queue to send notifications on (Default is `OperationQueue.main`)
